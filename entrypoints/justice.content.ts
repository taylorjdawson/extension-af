...
export default defineContentScript({
  ...
  runAt: 'document_idle',
  main(ctx) {
    // Justice sitewide alert structure from sample
    const selectors = [
      '[data-sitewide-alert] .sitewide-alert.alert.alert-primary',
    ...
    function removeBanners() {
      ...
      if (removed && !bannerWasRemoved) {
        ...
        console.log('[gov-shutdown-ext] Removed Justice shutdown banner');
      }
    }
